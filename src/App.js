/*
  Author: Nguyen Kieu
  Date: 10/05/2023
  Desc: write app calculator basic
*/
  ...
  return (
    <div className="container">
      <div className="wrapper">
        ...
        <div className='btn orange' onClick={operation}>/</div>
        <div className='btn' onClick={inputNum}>7</div>
        <div className='btn' onClick={inputNum}>8</div>
        <div className='btn' onClick={inputNum}>9</div>
        <div className='btn orange' onClick={operation}>x</div>
        ...
        <div className='btn orange' onClick={result}>=</div>
      </div>
    </div>
  );
}
